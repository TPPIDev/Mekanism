...
public class Mekanism
{
	...
	public void addRecipes()
	{
		...
		CraftingManager.getInstance().getRecipeList().add(new MekanismRecipe(ArmoredJetpack.getEmptyItem(), new Object[] {
			"D D", "BSB", " J ", Character.valueOf('D'), "dustDiamond", Character.valueOf('B'), "ingotBronze", Character.valueOf('S'), "blockSteel", Character.valueOf('J'), new ItemStack(Jetpack, 1, OreDictionary.WILDCARD_VALUE)
		}));
